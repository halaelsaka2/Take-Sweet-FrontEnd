...
const Paging = (props) => {
  var { count, pagesize, current, handlePageChange } = props;
    ...
    <div className="paging mr">
      <div className="paging__arrow">
        <i
          ...
          onClick={(current) => handlePageChange(current--)}
        ></i>
      </div>
      {pages.map((page) => (
        <div
          ...
          style={{ cursor: "pointer" }}
          onClick={(current) => handlePageChange(page)}
        >
          {page}
        </div>
      ))}
...
//             pagesize={10}
//             current={1}
//             handlePageChange={this.handlePaging}
//           />
//         )}
//       </React.Fragment>
//     );
